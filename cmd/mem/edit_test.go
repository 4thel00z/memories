...
func setupEditTest(t *testing.T) (*internal.GitRepository, *internal.GetMemoryUseCase, *internal.SetMemoryUseCase) {
	t.Helper()
	tmpDir := t.TempDir()
	...
	return repo, getUC, setUC
}

func TestEditCmdCreatesNew(t *testing.T) {
	repo, getUC, setUC := setupEditTest(t)
